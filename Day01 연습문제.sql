...
SELECT EMPLOYEE_ID, FIRST_NAME || ' ' ||LAST_NAME NAME , HIRE_DATE, SALARY FROM EMPLOYEES;
...
SELECT FIRST_NAME || ' ' ||LAST_NAME NAME, DEPARTMENT_ID, JOB_ID FROM EMPLOYEES 
WHERE DEPARTMENT_ID = 50;
--5. 모든 사원의 이름, 급여 그리고 300달러 인상된 급여를 출력하세요.
SELECT FIRST_NAME, SALARY, SALARY+300 "인상된 급여" FROM EMPLOYEES;
...
SALARY ||'달러 입니다' "정보" FROM EMPLOYEES WHERE FIRST_NAME ='Steven' AND LAST_NAME = 'King';
